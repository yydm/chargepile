                ...
                <table class="tabs-css-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="cdkssj" class="cls-txt2" /></td>
                        <td class="td-lable">
                            <label>
                                峰电量：</label>
                        </td>
            ...
            <div class="tabs-css">
                <table class="tabs-css-table2">
                    <tr>
                        ...
                        <td>
                            &nbsp;<input type="text" id="gdj" class="cls-txt4" /></td>
                    </tr>
                    <tr>
                        <td class="td-lable">
                            <label>
                        ...
                        <td>
                            &nbsp;<input type="text" id="jdj" class="cls-txt4" /></td>
                    </tr>
                    <tr>
                        <td class="td-lable">
                            <label>
                        ...
                        <td>
                            &nbsp;<input type="text" id="zlx" class="cls-txt3" /></td>
                        <td class="td-lable">
                            <label>
                                投运时间：</label>
                        </td>
                        <td>
                            &nbsp;<input type="text" id="tysj" class="cls-txt3" /></td>
                    </tr>
                    <tr>
                        <td class="td-lable">
                            &nbsp;</td>
            ...
            <div title="导航" style="padding: 5px">
                ...
                <div class="info-row">
                    ...
                    <div class="info-row-2" id="lk2">
                        <a href="#">
                            <img src="../../Images/运行信息.png" title="全景监视" width="53px" height="48px" onclick="yxinfo()" />全景监视</a>
                    </div>
                </div>
                <div class="info-row">
