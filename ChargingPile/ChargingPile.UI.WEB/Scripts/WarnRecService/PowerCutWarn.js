...
$(function () {
    ...
    $("#t_tdwarn").datagrid({
        ...
        queryParams: { action: "gettdwarn", zhanbh: zhanbh, processtype: protype, begintime: begintime, endtime: endtime },
        fit: true,
        nowrap: false,
        fitColumns: true,
        striped: true,
        ...
        onLoadSuccess: function () {
            $($('#t_tdwarn').datagrid("getPanel")).find('a.easyui-linkbutton').linkbutton();
        }
...
function search() {
    ...
    var begintime = $("#begintime").val();
    var endtime = $("#endtime").val();
    $("#t_tdwarn").datagrid("load", { action: "gettdwarn", zhanbh: zhanbh, processtype: protype, begintime: begintime, endtime: endtime });
}
