...
{
   public class ScheduleLogDal:BaseDal<ScheduleLog>
    {
        public override bool Exist(ScheduleLog bean)
        {
            Log.Debug("exist方法"+bean);
            var sql = new StringBuilder();
            sql.Append("select * from cmd_schedulelog t where id='" + bean.Id + "'");
            Log.Debug("SQL :" + sql);
        ...
        public override void Add(ScheduleLog bean)
        {
            ...
            var sql = "insert into cmd_schedulelog(" + sql1 + ") values(" + sql2 + ")";
        ...
        public override void Del(ScheduleLog bean)
        {
            ...
            var sql = new StringBuilder();
            sql.Append("delete from cmd_schedulelog where id='" + bean.Id + "'");
            Log.Debug("SQL :" + sql);
        ...
        public override void Modify(ScheduleLog bean)
        {
            ...
            var sql = new StringBuilder();
            sql.Append("update cmd_schedulelog set");
            var i = 0;
        ...
        public override DataTable Query(ScheduleLog bean)
        {
            ...
            var sql = new StringBuilder();
            sql.Append("select t.* from cmd_schedulelog t where 1=1 ");
            var list = new List<object>();
            var i = -1;
            if (string.IsNullOrEmpty(bean.Id))
            {
