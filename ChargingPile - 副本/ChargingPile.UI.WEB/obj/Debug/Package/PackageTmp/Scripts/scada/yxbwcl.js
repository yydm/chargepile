...
$(function () {
    $("#t_yctbcl").datagrid({
        ...
        columns: [[
            ...
            { field: "YXBH", title: "桩编号", align: "center", width: 80 },
            ...
            { field: "LOGDESC", title: "出错原因", align: "center", width: 120,
                formatter: function (val, src) {
...
function InvokeService(page, rows) {
    var req = {
        ...
        ["select * from (select rownum rn, count(*) over() DATACNT,ow.id, " +
            ...
            "and ow.logtype=#logtype) abc where rn between " + ((page - 1) * rows + 1)
            + " and " + page * rows,
            {
                "logtype": "004"
            }],
...
function showHistory() {
    location.href = "yxbwHistoryDetail.htm";
}
